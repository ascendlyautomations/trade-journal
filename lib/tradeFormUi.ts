...
/**
 * Quick Input modal field chrome — same readable text/placeholder as Add Trade.
 * Keeps Quick Input height / focus ring; does not change layout.
 */
...
/** Quick Input labels — Prop Firm label contrast with slight weight. */
