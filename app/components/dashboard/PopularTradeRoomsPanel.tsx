    ...
    <div className={className}>
      ...
      <label className={`block ${heading || subheading ? "mt-6" : ""}`}>
        ...
        <input
          ...
          className="w-full rounded-lg border border-white/15 bg-black/30 px-3 py-2 text-sm text-white placeholder:text-gray-400 focus:border-blue-400/50 focus:outline-none focus:ring-1 focus:ring-blue-400/40"
          autoComplete="off"
        />
      </label>
