    ...
    >
      ...
      {showEmpty ? (
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="flex min-h-[76px] flex-col items-center justify-center rounded-xl border border-white/10 bg-white/5 p-2.5 text-center max-md:py-2 md:min-h-[90px] md:p-3">
