-- Rollback: restores rpc_v1_prop_firm_bootstrap body from 20260824120000 (pre-fix).
-- Re-apply 20260824130000_fix_prop_firm_bootstrap_type_contract.sql to restore the fix.
