-- Normalized crop metadata for Posts / Trades / Achievements (Feed + Profile parity).
...
comment on column public.profile_posts.image_crop is
  'Authoritative Feed/Profile framing — normalized crop rect + presentation aspect (v1).';
comment on column public.trades.image_crop is
  'Authoritative Feed/Profile framing for trade screenshots.';
comment on column public.posts.image_crop is
  'Feed post row crop metadata when a trade is shared publicly.';
comment on column public.achievements.image_crop is
  'Authoritative Feed/Profile framing for achievement images.';
