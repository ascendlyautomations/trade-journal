-- Fix rpc_v1_calendar_bootstrap: trades.entry_time / exit_time are text (ISO-8601),
-- not timestamptz. Cast at the RPC boundary for window filters and wire serialization.
...
comment on function public.rpc_v1_calendar_bootstrap is
  'Phase 2 Calendar bootstrap — owner accounts + bounded month entry_time window (text ISO cast at RPC boundary).';
