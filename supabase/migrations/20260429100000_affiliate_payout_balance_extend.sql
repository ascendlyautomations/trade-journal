-- Extend affiliate_payout_balance JSON: totalPaid, minimumPayout ($100), canRequest.
...
comment on function public.affiliate_payout_balance(uuid) is
  'Affiliate payout balances + $100 minimum gate (canRequest). Caller must be p_user_id.';
