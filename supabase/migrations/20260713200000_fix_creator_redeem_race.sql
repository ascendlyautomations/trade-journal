-- Fix redeem_creator_access_code race + idempotency:
-- 1) Concurrent/same-user re-redeem returns 'already' (not invalid/exhausted).
-- 2) Exhausted slots return 'exhausted' (not invalid).
