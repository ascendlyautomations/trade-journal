-- Fix rpc_v1_prop_firm_bootstrap: trades.account_id is text, accounts.id is uuid.
-- Compare trades via text[] built from account UUIDs; never cast trade account_id to uuid.
