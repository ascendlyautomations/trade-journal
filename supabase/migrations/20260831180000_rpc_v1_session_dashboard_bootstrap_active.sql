-- Phase 1: Promote Session + Dashboard bootstrap RPCs into active migration history.
-- Includes helper functions, index, expanded owner account snapshot, achievement payout total.
...
comment on function public.rpc_v1_session_bootstrap() is
  'Backend V2 session bootstrap — viewer, accounts summary, following IDs, badges, prefs_min.';
...
comment on function public.rpc_v1_dashboard_bootstrap(uuid, integer) is
  'Backend V2 Dashboard bootstrap — full owner accounts, trade window, metrics/equity, achievement payout total.';
