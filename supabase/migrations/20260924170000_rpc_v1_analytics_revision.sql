-- Phase 6E — cheap authoritative analytical revision check (global high-water only).
-- No trades, stats payloads, or dashboard/calendar material.
...
comment on function public.rpc_v1_analytics_revision() is
  'Phase 6E: authenticated viewer global analytical revision high-water from user_analytics_state.';
