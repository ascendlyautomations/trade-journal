-- Beta Pro access: TRAXBETA referral also grants is_pro (no Stripe / subscription changes).
...
comment on function public.profiles_apply_beta_from_referred_by() is
  'Sets is_beta_tester and is_pro when referred_by matches TRAXBETA. Does not unset either flag.';
